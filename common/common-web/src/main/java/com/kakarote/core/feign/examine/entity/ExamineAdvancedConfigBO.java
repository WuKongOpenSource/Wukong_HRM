...
public class ExamineAdvancedConfigBO {
    ...
    @ApiModelProperty(value = "异常处理类型1：自动同意2：转交给指定人员处理")
    private Integer nodeHandleType;

    @ApiModelProperty(value = "转交指定处理人")
    private List<Long> nodeHandleUser;
    ...
    private ExamineAdvancedConfigLimitTimeBO advancedLimitTimeBO;
