...
public class ExamineAdvancedConfigLimitTimeBO {
    ...
    @ApiModelProperty(value = "超多少时间自动处理")
    private Double limitTime;

    @ApiModelProperty(value = "超多少时间自动处理-单位:minute:分钟，hour小时，day天")
    private String limitTimeUnit;

    @ApiModelProperty(value = "处理人员列表")
    private List<Long> handleUserList;

    @ApiModelProperty(value = "转交指定处理人角色")
    private List<Long> nodeHandleRole;

    @ApiModelProperty(value = "转交指定处理人指定上级")
    private List<Integer> nodeHandleParentLevel;
