...
public class HrmAchievementAppraisalController {
    ...
    @ApiOperation("删除考核")
    public Result deleteAppraisal(@PathVariable("appraisalId") Long appraisalId) {
    ...
    @ApiOperation("终止考核")
    public Result stopAppraisal(@PathVariable("appraisalId") Long appraisalId) {
    ...
    @ApiOperation("查询考核详情")
    public Result<AppraisalInformationBO> queryAppraisalById(@PathVariable("appraisalId") Long appraisalId) {
    ...
    public Result<Map<String, Object>> queryEmployeeAppraisalCount(@PathVariable("employeeId") Long employeeId) {
    ...
    public Result<EmployeeAppraisalDetailVO> queryEmployeeDetail(@PathVariable("employeeAppraisalId") Long employeeAppraisalId) {
