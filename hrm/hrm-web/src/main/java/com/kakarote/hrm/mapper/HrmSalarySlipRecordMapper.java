...
public interface HrmSalarySlipRecordMapper extends BaseMapper<HrmSalarySlipRecord> {
    ...
    BasePage<SlipEmployeeVO> querySlipEmployeePageList(BasePage<SlipEmployeeVO> page, @Param("sRecordId") Long sRecordId, @Param("data") QuerySlipEmployeePageListBO slipEmployeePageListBO);
    ...
    List<Long> querySlipEmployeeIds(@Param("sRecordId") Long sRecordId, @Param("data") SendSalarySlipBO sendSalarySlipBO);
}
