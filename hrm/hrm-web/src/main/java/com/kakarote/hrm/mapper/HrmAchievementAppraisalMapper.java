...
public interface HrmAchievementAppraisalMapper extends BaseMapper<HrmAchievementAppraisal> {
    ...
    Map<String, Object> queryEmployeeLastAppraisal(Long employeeId);

    BasePage<EmployeeAppraisalVO> queryEmployeeAppraisal(BasePage<EmployeeAppraisalVO> parse, @Param("employeeId") Long employeeId);

    String queryDeptAppraisalRange(Long appraisalId);

    String queryEmployeeAppraisalRange(Long appraisalId);
}
