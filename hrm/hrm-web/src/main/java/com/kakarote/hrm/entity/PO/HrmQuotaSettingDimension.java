...
@TableName("wk_hrm_quota_setting_dimension")
@ApiModel(value = "HrmQuotaSettingDimension对象", description = "考核计划-指标设置-考核维度")
public class HrmQuotaSettingDimension implements Serializable {
