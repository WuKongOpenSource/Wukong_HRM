...
public interface IHrmSalaryGroupService extends BaseService<HrmSalaryGroup> {
     ...
     * @return
     */
    HrmSalaryTaxRule queryEmployeeTaxRule(Long employeeId);
     ...
     * @param salaryGroup
     */
    OperationLog setSalaryGroup(SetSalaryGroupBO salaryGroup);
     ...
     * @return
     */
    OperationLog deleteSalaryGroup(Long groupId);
}
