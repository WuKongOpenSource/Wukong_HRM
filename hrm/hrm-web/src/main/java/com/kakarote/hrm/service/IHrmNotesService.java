...
public interface IHrmNotesService extends BaseService<HrmNotes> {
     ...
     * @return
     */
    List<HrmNotes> queryNoteListByTime(LocalDate time, Collection<Long> employeeIds);
     ...
     * @return
     */
    Set<String> queryNoteStatusList(QueryNotesStatusBO queryNotesStatusBO, Collection<Long> employeeIds);
}
