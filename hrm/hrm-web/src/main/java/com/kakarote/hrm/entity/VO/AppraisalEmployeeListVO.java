...
public class AppraisalEmployeeListVO {
    ...
    public String toString() {
        return "AppraisalEmployeeListVO{" +
                ...
                ", apprailsaledCnt=" + apprailsaledCnt +
                ", apprailsalingCnt=" + apprailsalingCnt +
                ", lastAppraisalName='" + lastAppraisalName + '\'' +
                ", lastAppraisalResult='" + lastAppraisalResult + '\'' +
                ", isDel=" + isDel +
                '}';
    }
}
