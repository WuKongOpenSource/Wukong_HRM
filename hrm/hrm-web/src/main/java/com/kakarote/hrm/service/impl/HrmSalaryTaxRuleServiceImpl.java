...
public class HrmSalaryTaxRuleServiceImpl extends BaseServiceImpl<HrmSalaryTaxRuleMapper, HrmSalaryTaxRule> implements IHrmSalaryTaxRuleService {
    ...
    @Override
    public OperationLog setTaxRule(SetTaxRuleBO setTaxRuleBO) {
        ...
        operationLog.setOperationObject(taxRule.getRuleName());
        operationLog.setOperationInfo("编辑计税规则：" + taxRule.getRuleName());
