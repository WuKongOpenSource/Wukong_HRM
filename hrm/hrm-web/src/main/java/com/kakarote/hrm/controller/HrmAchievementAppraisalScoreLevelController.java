...
public class HrmAchievementAppraisalScoreLevelController {
    ...
    public Result<List<HrmAchievementAppraisalScoreLevel>> queryScoreLevelList(@PathVariable("employeeAppraisalId") Long employeeAppraisalId) {
    ...
    @ApiOperation("查询分数配置列表")
    public Result<List<HrmAchievementAppraisalScoreLevel>> queryScoreLevelListByAppraisalId(@PathVariable("appraisalId") Long appraisalId) {
