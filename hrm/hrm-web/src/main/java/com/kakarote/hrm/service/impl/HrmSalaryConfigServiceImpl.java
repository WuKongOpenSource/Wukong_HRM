...
public class HrmSalaryConfigServiceImpl extends BaseServiceImpl<HrmSalaryConfigMapper, HrmSalaryConfig> implements IHrmSalaryConfigService {
    ...
    public QueryInItConfigVO queryInItConfig() {
        ...
        if (salaryConfig != null) {
            Optional<HrmInsuranceMonthRecord> insuranceMonthRecordOpt = insuranceMonthRecordService.lambdaQuery().orderByDesc(HrmInsuranceMonthRecord::getCreateTime).oneOpt();
            ...
            Optional<HrmSalaryMonthRecord> salaryMonthRecordOpt = ApplicationContextHolder.getBean(IHrmSalaryMonthRecordService.class).lambdaQuery().orderByDesc(HrmSalaryMonthRecord::getCreateTime).oneOpt();
            ...
            HrmSalarySlipRecord slipRecord = slipRecordService.lambdaQuery().orderByDesc(HrmSalarySlipRecord::getYear, HrmSalarySlipRecord::getMonth).one();
            if (slipRecord == null) {
