...
public abstract class ExcelImport implements Runnable {
    ...
    protected IAdminMessageService adminService = ApplicationContextHolder.getBean(IAdminMessageService.class);

    protected AdminFileService fileService = ApplicationContextHolder.getBean(AdminFileService.class);
    ...
    public void run() {
        ...
        AdminMessage adminMessage = adminService.getById(getUploadExcelBO().getMessageId());
        ...
        try {
            ...
            if (errorList.size() >= 2) {
                ...
                String errorFilePath = uploadEntity.getPath();
