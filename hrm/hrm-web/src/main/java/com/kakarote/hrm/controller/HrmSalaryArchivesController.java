...
public class HrmSalaryArchivesController {
    ...
    @ApiOperation("单个定薪")
    @OperateLog(apply = ApplyEnum.HRM, object = OperateObjectEnum.HRM_SALARY_ARCHIVES, behavior = BehaviorEnum.FIX_SALARY)
    public Result setFixSalaryRecord(@RequestBody SetFixSalaryRecordBO setFixSalaryRecordBO) {
        OperationLog operationLog = salaryArchivesService.setFixSalaryRecord(setFixSalaryRecordBO);
        return OperationResult.ok(operationLog);
    }

    @PostMapping("/queryFixSalaryRecordById/{id}")
    @ApiOperation("查询定薪记录详情")
    public Result<FixSalaryRecordDetailVO> queryFixSalaryRecordById(@PathVariable("id") Long id) {
    ...
    @ApiOperation("单个调薪")
    @OperateLog(apply = ApplyEnum.HRM, object = OperateObjectEnum.HRM_SALARY_ARCHIVES, behavior = BehaviorEnum.CHANGE_SALARY)
    public Result setChangeSalaryRecord(@RequestBody SetChangeSalaryRecordBO setChangeSalaryRecordBO) {
        OperationLog operationLog = salaryArchivesService.setChangeSalaryRecord(setChangeSalaryRecordBO);
        return OperationResult.ok(ListUtil.toList(operationLog));
    }

    @PostMapping("/queryChangeSalaryRecordById/{id}")
    @ApiOperation("查询调薪记录详情")
    public Result<ChangeSalaryRecordDetailVO> queryChangeSalaryRecordById(@PathVariable("id") Long id) {
    ...
    @ApiOperation("取消调薪")
    public Result cancelChangeSalary(@PathVariable("id") Long id) {
    ...
    @ApiOperation("删除调薪")
    public Result deleteChangeSalary(@PathVariable("id") Long id) {
    ...
    public OperationResult<Map<String, Object>> batchChangeSalaryRecord(@RequestBody BatchChangeSalaryRecordBO batchChangeSalaryRecordBO) {
        Map<String, Object> result = salaryArchivesService.batchChangeSalaryRecord(batchChangeSalaryRecordBO);
    ...
    @ApiOperation("下载调薪模板")
    public void downLoadChangeTemplate(@RequestBody QuerySalaryArchivesListBO querySalaryArchivesListBO, HttpServletResponse response) {
