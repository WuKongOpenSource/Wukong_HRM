...
public interface IHrmAchievementAppraisalScoreLevelService extends BaseService<HrmAchievementAppraisalScoreLevel> {
     ...
     */
    List<HrmAchievementAppraisalScoreLevel> queryScoreLevelList(Long employeeAppraisalId);
     ...
     */
    List<HrmAchievementAppraisalScoreLevel> queryScoreLevelListByAppraisalId(Long appraisalId);
}
