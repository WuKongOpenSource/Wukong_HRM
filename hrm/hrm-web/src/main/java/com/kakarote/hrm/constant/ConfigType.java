...
public enum ConfigType {
     ...
     * 人力资源配置类型枚举
     */
    ELIMINATION_REASONS(1, "淘汰原因"), SALARY_INIT_CONFIG1(2, "薪资初始化配置1"), SALARY_INIT_CONFIG2(3, "薪资初始化配置2"), INSURANCE_INIT_CONFIG1(4, "社保初始化配置1"), INSURANCE_INIT_CONFIG2(5, "社保初始化配置2");
