...
public interface IHrmAchievementAppraisalService extends BaseService<HrmAchievementAppraisal> {
     ...
     */
    void deleteAppraisal(Long appraisalId);
     ...
     * @param appraisalId 绩效id
     */
    void stopAppraisal(Long appraisalId);
     ...
     * @return 绩效详情
     */
    AppraisalInformationBO queryAppraisalById(Long appraisalId);
     ...
     * @return 员工绩效详情
     */
    EmployeeAppraisalDetailVO queryEmployeeDetail(Long employeeAppraisalId);
     ...
     */
    Map<String, Object> queryEmployeeAppraisalCount(Long employeeId);
}
