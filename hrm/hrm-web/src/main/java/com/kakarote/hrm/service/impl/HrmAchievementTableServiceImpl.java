...
public class HrmAchievementTableServiceImpl extends BaseServiceImpl<HrmAchievementTableMapper, HrmAchievementTable> implements IHrmAchievementTableService {
    ...
    public HrmAchievementTable setAchievementTable(SetAchievementTableBO setAchievementTableBO) {
        ...
        boolean exists = achievementAppraisalService.lambdaQuery().eq(HrmAchievementAppraisal::getTableId, hrmAchievementTable.getTableId()).exists();
        if (exists) {
            ...
            List<Long> segIdList = achievementSegService.lambdaQuery().select(HrmAchievementSeg::getSegId)
        ...
        Long tableId = hrmAchievementTable.getTableId();
     ...
     * 转换考核模板项
     */
    private void transferSeg(Long tableId, List<HrmAchievementSegItem> items, HrmAchievementSeg seg, IsEnum isEnum) {
        seg.setSegId(null);
    ...
    @Override
    public AchievementTableVO queryAchievementTableById(Long tableId) {
