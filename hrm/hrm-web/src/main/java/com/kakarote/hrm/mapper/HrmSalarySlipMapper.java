...
public interface HrmSalarySlipMapper extends BaseMapper<HrmSalarySlip> {
    ...
    BasePage<QuerySalarySlipListVO> querySalarySlipList(BasePage<QuerySalarySlipListVO> parse, @Param("data") QuerySalarySlipListBO querySalarySlipListBO, @Param("employeeId") Long employeeId);
}
