...
@TableName("wk_hrm_quota_setting_dimension_quota")
@ApiModel(value = "HrmQuotaSettingDimensionQuota对象", description = "考核计划-指标设置-考核维度-考核指标")
public class HrmQuotaSettingDimensionQuota implements Serializable {
